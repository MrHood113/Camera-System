...
const CameraTable: React.FC = () => {
  ...
  // console.log("Cameras with null id:", cameras.filter((cam) => cam.id == null));


  return (
    <div className="scale-95 text-sm">
      <div className="bg-white px-4 pb-7 rounded-lg shadow flex flex-col h-150" style={{ maxHeight: 'calc(100vh - 130px)' }}>
        <div className="flex items-center justify-between w-full py-5">
          <h2 className="text-3xl font-semibold mb-4 text-center flex-1 pl-64">Camera List</h2>

          <div className="relative hidden md:block mr-4 p-1 items-center justify-center">
            <input
                type="text"
                placeholder="Search..."
                value={searchQuery}
